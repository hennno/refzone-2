...
Let me continue with the signup page:

<dyad-write path="src/pages/Signup.tsx" description="Create signup page with username, email, password, and terms agreement">
import { useState } from 'react';
import { Link, useNavigate } from 'react-router-dom';
import { useAuth } from '@/hooks/useAuth';
import { Button } from '@/components/ui/button';
